...
import com.my.command.filter.ProfileFilterCommand;
...
class ProfileFilterCommandTest {
    @Test
    void deniedAccess() throws IOException, ServletException {
        final ProfileFilterCommand profileFilterCommand = new ProfileFilterCommand();
        ...
        profileFilterCommand.getAccess(request, response);
